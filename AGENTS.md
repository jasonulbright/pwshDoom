...
- The user authorized private GitHub backup on 2026-09-11. `origin` is `https://github.com/jasonulbright/pwshDoom.git`; push reviewed milestone commits there after checks and verify the remote branch matches. Keep the repository private. Ignored `local/` assets and recordings are outside this Git backup.
