...
class ThingMovement {
    ...
    [Fixed] $currentX = [Fixed]::Zero
    [Fixed] $currentY = [Fixed]::Zero
    [Fixed[]] $currentBox

    [Fixed] $currentFloorZ = [Fixed]::Zero
    [Fixed] $currentCeilingZ = [Fixed]::Zero
    [Fixed] $currentDropoffZ = [Fixed]::Zero
    [bool] $floatOk
    ...
    [Fixed] $bestSlideFrac = [Fixed]::Zero
    [Fixed] $secondSlideFrac = [Fixed]::Zero

    [LineDef] $bestSlideLine
    [LineDef] $secondSlideLine

    [Mobj] $slideThing
    [Fixed] $slideMoveX = [Fixed]::Zero
    [Fixed] $slideMoveY = [Fixed]::Zero
