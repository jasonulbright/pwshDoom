...
class Mobj : Thinker {
    ...
    [Fixed] $floorZ = [Fixed]::Zero
    [Fixed] $ceilingZ = [Fixed]::Zero

    [Fixed] $radius = [Fixed]::Zero
    [Fixed] $height = [Fixed]::Zero

    [Fixed] $momX = [Fixed]::Zero
    [Fixed] $momY = [Fixed]::Zero
    [Fixed] $momZ = [Fixed]::Zero
    ...
    [bool] $interpolate
    [Fixed] $oldX = [Fixed]::Zero
    [Fixed] $oldY = [Fixed]::Zero
    [Fixed] $oldZ = [Fixed]::Zero
