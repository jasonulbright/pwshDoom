...
class BlockMap {
    ...
    # pwshDoom, 2026-09-10: qualify the static collision-grid constant.
    static [Fixed]$BlockSize = [Fixed]::FromInt([BlockMap]::IntBlockSize)
    ...
    [Fixed]$originX = [Fixed]::Zero
    [Fixed]$originY = [Fixed]::Zero
    [int]$width
    [int]$height
    [short[]]$table
    [LineDef[]]$lines
