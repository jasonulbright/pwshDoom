# pwshDoom modification, 2026-09-10: correct the animation-definition array type.
##
...
class DoomInfo {
    ...
    # pwshDoom, 2026-09-10: publish the initialized animation definitions.
    static [AnimationDef[]]$TextureAnimation = ([DoomAnimation]::new()).TextureAnimation
