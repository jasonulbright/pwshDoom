...
class ThreeDRenderer {
    ...
    [int] $centerX
    [int] $centerY
    [Fixed] $centerXFrac = [Fixed]::Zero
    [Fixed] $centerYFrac = [Fixed]::Zero
    [Fixed] $projection = [Fixed]::Zero
    ...
    [Angle] $clipAngle = [Angle]::Ang0
    [Angle] $clipAngle2 = [Angle]::Ang0
    ...
    [Fixed] $skyTextureAlt = [Fixed]::Zero
    [Fixed] $skyInvScale = [Fixed]::Zero
    ...
    [void] ClearRenderingHistory() {
        ...
        # pwshDoom, 2026-09-10: preserve full projection, clip this worker's strip.
    ...
    [Fixed] $weaponScale = [Fixed]::Zero
    [Fixed] $weaponInvScale = [Fixed]::Zero
    ...
    [Fixed] $viewX = [Fixed]::Zero
    [Fixed] $viewY = [Fixed]::Zero
    [Fixed] $viewZ = [Fixed]::Zero
    [Angle] $viewAngle = [Angle]::Ang0

    [Fixed] $viewSin = [Fixed]::Zero
    [Fixed] $viewCos = [Fixed]::Zero
    [int] $viewXData
    [int] $viewYData
    [int] $viewZData
    [int] $viewNegYData
...
class VisWallRange {
    ...
    [Fixed]$Scale1 = [Fixed]::Zero
    [Fixed]$Scale2 = [Fixed]::Zero
    [Fixed]$ScaleStep = [Fixed]::Zero

    [Silhouette]$Silhouette
    [Fixed]$UpperSilHeight = [Fixed]::Zero
    [Fixed]$LowerSilHeight = [Fixed]::Zero

    [int]$UpperClip
    [int]$LowerClip
    [int]$MaskedTextureColumn

    [Fixed]$FrontSectorFloorHeight = [Fixed]::Zero
    [Fixed]$FrontSectorCeilingHeight = [Fixed]::Zero
    [Fixed]$BackSectorFloorHeight = [Fixed]::Zero
    [Fixed]$BackSectorCeilingHeight = [Fixed]::Zero
}
...
class VisSprite {
    ...
    [Fixed]$GlobalX = [Fixed]::Zero
    [Fixed]$GlobalY = [Fixed]::Zero

    # Global bottom / top for silhouette clipping.
    [Fixed]$GlobalBottomZ = [Fixed]::Zero
    [Fixed]$GlobalTopZ = [Fixed]::Zero

    # Horizontal position of x1.
    [Fixed]$StartFrac = [Fixed]::Zero

    [Fixed]$Scale = [Fixed]::Zero

    # Negative if flipped.
    [Fixed]$InvScale = [Fixed]::Zero

    [Fixed]$TextureAlt = [Fixed]::Zero
    [Patch]$Patch
