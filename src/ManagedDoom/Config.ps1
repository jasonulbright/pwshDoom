# pwshDoom modification, 2026-09-10: parameterless construction initializes existing defaults.
##
...
class Config {
    ...
    # pwshDoom, 2026-09-10: allow defaults without reading a user config file.
    Config() { $this.InitializeDefaults() }
