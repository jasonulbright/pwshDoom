...
Current audio continuation: E1M1, E1M2, intermission and E1M3 have qualified dry loops. A [finite preparation command](music-preparation.md) now handles new tracks, verified reuse and completed-track resume. The full [E1M1/intermission/E1M2 music route](campaign-music.md) preserves all 1,747 commands and eight checkpoints in recorded Matrix/color-art runs. Their intermission/finale presentation now uses the existing readable block UI encoder. An [isolated route study](audio-recovery.md) adds tested reserve recovery. The [loading boundary](loading-boundary.md) now drains old audio and enters the reported loading pause before world construction; its recorded route retains identical submitted PCM and all checkpoints, but later empty queues remain. Next address UI work before packet publication and playback after loading, then extend soundtrack/campaign coverage. No new map completion or soundtrack-wide qualification follows from this milestone.
