...
| M3 — Audio | PowerShell-controlled effects/music and declared device backend | Offline output correctness, real playback review, underrun/latency/load measurements | [Opt-in PowerShell effects and Windows playback](audio.md) integrated; full-host replay/pause/resize PCM identity verified; music, volume, audible latency and broader qualification pending |
