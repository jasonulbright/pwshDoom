...
| M3 — Audio | PowerShell-controlled effects/music and declared device backend | Offline output correctness, real playback review, underrun/latency/load measurements | [Opt-in PowerShell effects and Windows playback](audio.md) integrated; volume/mute and full-host PCM identity verified; [dry PowerShell music](music-synthesis.md) renders E1M1 through a loop, with 34 tests and 40 evidence checks; full fixture costs 664 seconds for 98 seconds of audio; optimization, music effects/live integration, fidelity and audible latency remain |
