...
| M3 — Audio | PowerShell-controlled effects/music and declared device backend | Offline output correctness, real playback review, underrun/latency/load measurements | [PowerShell effects mixer and Windows device queue](audio.md) tested offline/API-side; live integration, music, latency/load and audibility qualification pending |
