...
The subsequent [loading-boundary change](loading-boundary.md) enters loading before world construction and drains the old audio tail before pausing. Its recorded route preserves the same PCM and checkpoints, with the full loading interval reported. Intermission/UI work before audio packet publication, broader campaign, uninterrupted playback and 35-tic/60-display qualification remain open.
